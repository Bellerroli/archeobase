...
public class StratDto {
    ...
    private List<Meret> meretList;

    public StratDto(int id, int SNR, int OBNR, String tipus, String allapot, String leiras, boolean feltDat, String kor, String korszak, int asatasId, List<Meret> meretList) {
        this.id = id;
        this.SNR = SNR;
        this.OBNR = OBNR;
        this.tipus = tipus;
    ...
    public List<Meret> getMeretList() {
        return meretList;
    }

    public void setMeretList(List<Meret> meretList) {
        this.meretList = meretList;
    }
}
